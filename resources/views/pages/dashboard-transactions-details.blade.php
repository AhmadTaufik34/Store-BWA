...
<div
    ...
    <div class="container-fluid">
        ...
        <div class="dashboard-content" id="transactinDetails">
        <div class="row">
            <div class="col-12">
            <div class="card">
                <div class="card-body">
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="product-subtitle">Rp. {{ number_format($transaction->transaction->total_price, 0, ',', '.') }}</div>
                        </div>
                        <div class="col-12 col-md-6">
